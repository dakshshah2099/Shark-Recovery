    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#0c182b] border border-slate-200 dark:border-[#172a46] rounded-lg p-5 sm:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-5 shadow-xs transition-colors">
        <div className="space-y-1.5 max-w-2xl">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-blue-50 dark:bg-sky-950/60 border border-blue-200 dark:border-sky-800/60 text-xs font-semibold text-blue-700 dark:text-sky-300">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full md:w-auto">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onSeedDB}
              className="h-9 px-3.5 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-[#132238] dark:hover:bg-[#1c3252] text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-[#172a46] text-xs font-semibold inline-flex items-center justify-center gap-1.5 cursor-pointer transition-colors"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-[#0c182b] border border-slate-200 dark:border-[#172a46] rounded-lg p-5 sm:p-6 flex flex-col justify-between shadow-xs transition-colors">
          <div>
            <div className="flex items-center justify-between pb-3.5 border-b border-slate-100 dark:border-[#172a46] mb-4">
              ...
              <button
                ...
                className="text-xs font-semibold text-blue-600 dark:text-sky-400 hover:underline inline-flex items-center gap-1 cursor-pointer"
              >
            ...
            {activeTxns.length === 0 ? (
              <div className="py-10 text-center text-xs text-slate-500 dark:text-slate-400 rounded-md border border-dashed border-slate-200 dark:border-[#172a46]">
                <Activity className="w-6 h-6 mx-auto text-slate-400 dark:text-slate-500 mb-1.5" />
                <p className="font-semibold text-slate-800 dark:text-slate-200">No active recovery tasks in flight.</p>
                <p className="text-slate-500 dark:text-slate-400 mt-0.5">Use "Simulate 5 Failures" or Ingestion tab to start.</p>
              </div>
            ) : (
                ...
                {activeTxns.slice(0, 5).map((t) => (
                  <div key={t.id} className="py-2.5 flex items-center justify-between text-xs">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-[11px] text-blue-600 dark:text-sky-400 font-mono font-medium">
          ...
          <div className="pt-3.5 border-t border-slate-100 dark:border-[#172a46] flex items-center justify-between text-xs text-slate-600 dark:text-slate-300">
            <span>Deterministic Guardrail: Bounded to 2 Retries</span>
            <button
              onClick={() => onNavigateTab('ingest')}
              className="text-blue-600 dark:text-sky-400 hover:underline font-semibold cursor-pointer inline-flex items-center gap-1"
            >
        ...
        <div className="bg-white dark:bg-[#0c182b] border border-slate-200 dark:border-[#172a46] rounded-lg p-5 sm:p-6 flex flex-col justify-between shadow-xs transition-colors">
          <div className="space-y-3.5">
            ...
            <div className="space-y-2 text-xs">
              <div className="bg-slate-50 dark:bg-[#080d1a] p-3 rounded-md border border-slate-200/60 dark:border-[#172a46]">
                <div className="text-slate-500 dark:text-slate-400 font-medium text-[11px]">1. Diagnostic Agent</div>
              ...
              <div className="bg-slate-50 dark:bg-[#080d1a] p-3 rounded-md border border-slate-200/60 dark:border-[#172a46]">
                <div className="text-slate-500 dark:text-slate-400 font-medium text-[11px]">2. Strategy Agent</div>
                <div className="text-slate-900 dark:text-white font-mono text-[11px] mt-0.5 font-semibold">
              ...
              <div className="bg-slate-50 dark:bg-[#080d1a] p-3 rounded-md border border-slate-200/60 dark:border-[#172a46]">
                <div className="text-slate-500 dark:text-slate-400 font-medium text-[11px]">3. Execution Layer</div>
                <div className="text-slate-900 dark:text-white font-mono text-[11px] mt-0.5 font-semibold">
          ...
          <div className="pt-3.5 border-t border-slate-100 dark:border-[#172a46] flex items-center justify-between text-xs">
            <span className="text-slate-600 dark:text-slate-300">Total Captured:</span>
            <span className="inline-flex items-center gap-1 text-emerald-700 dark:text-emerald-300 font-mono font-bold">

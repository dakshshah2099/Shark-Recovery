      ...
      <div className="p-6 border-b border-slate-200 dark:border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="relative w-full sm:w-96">
          ...
          <input
            ...
            className="w-full bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/[0.08] text-xs text-slate-900 dark:text-white rounded-xl pl-10 pr-4 py-2.5 focus:outline-none focus:border-blue-500 transition-colors"
          />
        </div>
        ...
        <div className="flex items-center gap-2.5 w-full sm:w-auto">
          ...
          <div className="relative">
            <select
              ...
              className="bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/[0.08] text-xs text-slate-900 dark:text-white rounded-xl px-3.5 py-2.5 pr-8 focus:outline-none focus:border-blue-500 appearance-none font-medium cursor-pointer"
            >
            ...
            <ChevronDown className="w-3.5 h-3.5 text-slate-400 dark:text-zinc-500 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" />
          </div>
        </div>
      </div>
                      ...
                      {txn.status !== 'recovered' && (
                        <>
                          <button
                            ...
                            className="bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] font-semibold px-3 py-1.5 rounded-lg flex items-center gap-1 cursor-pointer shadow-xs transition-colors"
                          ...
                          <button
                            ...
                            className="bg-slate-100 hover:bg-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-slate-700 dark:text-zinc-300 text-[11px] font-semibold px-3 py-1.5 rounded-lg flex items-center gap-1 cursor-pointer border border-slate-200 dark:border-zinc-700 transition-colors"

...
export const AgentStepFlow: React.FC<AgentStepFlowProps> = () => {
  ...
  return (
    <div className="w-full bg-white dark:bg-[#121215] border border-zinc-200 dark:border-[#27272a] rounded-lg p-5 space-y-4 shadow-xs transition-colors">
        ...
        {steps.map((step, idx) => {
          ...
          return (
            <button
              ...
              className={`p-3 rounded-md border text-left transition-all cursor-pointer flex flex-col justify-between h-28 relative ${
                isSelected
            ...
            >
              ...
              <div className="flex items-center justify-between text-[10px] text-zinc-400 dark:text-zinc-500 pt-1 border-t border-zinc-200/60 dark:border-[#27272a]/60">
                ...
                {isSelected ? <ChevronUp className="w-3 h-3 text-blue-600 dark:text-blue-400" /> : <ChevronDown className="w-3 h-3 text-zinc-400 dark:text-zinc-500" />}
              </div>
            </button>
          );
        })}
      ...
      {activeStep && (
        <div className="bg-zinc-50 dark:bg-[#18181b] border border-zinc-200 dark:border-[#27272a] rounded-md p-4 space-y-3 animate-in fade-in duration-150">
          {(() => {
